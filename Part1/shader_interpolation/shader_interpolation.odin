...
main :: proc() {
    // Read shader files
    vertex, ok_vertex := os.read_entire_file("Part1/shader_interpolation/vertex.vert")
    if !ok_vertex {
    ...
    fragment, ok_fragment := os.read_entire_file("Part1/shader_interpolation/fragment.frag")
    if !ok_fragment {
