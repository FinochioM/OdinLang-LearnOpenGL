...
main :: proc() {
    ...
    // Shader Class
    shaderID : Shader = LoadShader("Part1/Exercises/textures_1/vertex.vert", "Part1/Exercises/textures_1/fragment.frag")
    ...
    data1 := stb.load("Part1/textures/brick.jpeg", &width1, &height1, &nrChannels1, 0)
    ...
    stb.set_flip_vertically_on_load(1)
    data2 := stb.load("Part1/textures/background.png", &width2, &height2, &nrChannels2, 0)
